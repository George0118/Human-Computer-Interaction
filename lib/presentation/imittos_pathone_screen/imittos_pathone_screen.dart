...
class ImittosPathoneScreen extends StatefulWidget {
  @override
  _ImittosPathoneScreenState createState() => _ImittosPathoneScreenState();
}

class _ImittosPathoneScreenState extends State<ImittosPathoneScreen> {
  late User curr_user;
  ...
  Future<double> getRating() async {
    double rating = 0;
    log("rating is " + rating.toString());
    await MyDatabase.instance.readRatingforPath("HP1").then((value) {
                            ...
                            child: Column(
                                ...
                                children: [
                                  Container(
                                      ...
                                      child: Text(
                                          "msg_kesariani_fire_lookout3".tr,
                                          maxLines: null,
                                          textAlign: TextAlign.left,
                                  ...
                                  Align(
                                      ...
                                      child: Container(
                                          ...
                                          child: Text("msg_try_this_3_1_km".tr,
                                              maxLines: null,
                                              textAlign: TextAlign.left,
                                              style: TextStyle(
                                                  fontSize: 4 * _value))))
...
Widget title = Text("Kesariani Fire Lookout Station - Kalopoula");
double zoom = 14.0;
Set<Marker> markers = {
  Marker(
      markerId: MarkerId("Kesariani Fire Lookout Station"),
      position: LatLng(37.96491467204881, 23.790001068740168),
      infoWindow: InfoWindow(title: "Kesariani Fire Lookout Station")),
  Marker(
      markerId: MarkerId("Kalopoula"),
      position: LatLng(37.96364647277947, 23.804407168740298),
      infoWindow: InfoWindow(title: "Kalopoula")),
};
